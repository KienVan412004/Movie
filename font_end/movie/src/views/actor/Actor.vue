<template>
  <Menu>
    <div class="actor">
      ...
      <div
        style="min-height: 580px; background-color: white; border-radius: 30px; margin-top: 30px"
      >
        <div
          style="
            height: 80px;
        ...
        >
          <img
            src="https://cdn-icons-png.flaticon.com/256/5362/5362466.png"
            alt="imade"
        ...
        <div class="container mx-auto px-6 pt-10">
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div style="display: flex">
              <div style="width: 47%; margin-right: 20px" class="relative max-w-sm">
              ...
              <div style="width: 47%" class="relative max-w-sm">
                <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                  <svg
                    class="w-4 h-4 text-gray-500 dark:text-gray-400"
                    aria-hidden="true"
            ...
            <div style="display: flex; justify-content: end">
              <button class="btn-add" type="button">
                <ClAddPlus style="width: 25px; height: 25px; color: white" /> Thêm Mới
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="container mx-auto px-6 pt-10">
          <div class="relative overflow-x-auto">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr v-for="(item, index) in 5" :key="index" class="bg-white dark:bg-gray-800">
                  <td class="px-6 py-4">1</td>
                  <th
                    scope="row"
                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                  >
                    Apple MacBook Pro 17" - {{ index + 1 }}
                  </th>
                  <td class="px-6 py-4">1</td>
                  ...
                  <td class="px-6 py-4">
                    <!-- <button class="btn-view mx-2" type="button">
                      <AkEyeOpen
                        style="width: 25px; height: 25px; margin-left: 3px; color: white"
                      />
                    </button> -->
                    <button data-modal-target="default-modal" data-modal-toggle="default-modal"  class="btn-update mx-2" type="button">
                      <BxPen style="width: 25px; height: 25px; margin-left: 3px; color: white" />
                    </button>
                    <button class="btn-delete mx-2" type="button">
            ...
            <div style="display: flex; justify-content: end" class="mx-auto px-6 py-6">
    ...
    <div style="display: flex;justify-content: center;" class="relative p-4 w-full max-h-full">
        ...
        >
          <img
            src="https://icon-library.com/images/icon-for-game/icon-for-game-15.jpg"
            alt="imade"
          ...
          <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ngày Tạo</label>
              <div style="" class="relative max-w-sm">
                <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                  <svg
                    class="w-4 h-4 text-gray-500 dark:text-gray-400"
                    aria-hidden="true"
            ...
            <!-- Modal footer -->
            <div style="display: flex;justify-content: end;" class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button data-modal-hide="default-modal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cập nhật</button>
